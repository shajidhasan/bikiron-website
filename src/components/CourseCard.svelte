	...
	<div class="flex justify-between items-center">
		{#if courseInfo.discount}
			<div class="flex flex-row items-center space-x-4">
				...
				<div class="rounded-md py-1 px-3 text-lg bg-rose-100 text-rose-600 font-bold">
		...
		{/if}
		<p class="font-bold text-rose-600">{courseInfo.lectureCount} lectures</p>
	</div>
    {:else}
    <h1 class="text-lg font-bold text-rose-500">Upcoming!</h1>
